@extends('layouts.app')
@section('content')
    <h1 class="titleheader" style="background: lightseagreen;">Create exercise</h1>
    ...
    <div style="display: flex">
        <div style="width:50%;margin-right: 10px;"> {{-- left div --}}
            ...
            <div class="form-group">
                ...
                {{Form::textarea('body','',['class' => 'form-control','style' => 'height:100%','placeholder' => 'Exercise description'])}}
            </div>
        </div>
        ...
        <div style="width:50%;">  {{-- right div --}}
            <div class="form-group">
                ...
                {{Form::text('muscle_group', '', ['class' => 'form-control','readonly'=>'readonly'])}}
            </div>
                ...
                <div class="body">
                    ...
                    <div id="malefigures" style="display: block;">
                        <div id="muscle-map"><img id="background" src="{{ asset('/images/body/00.png') }}">
                            <img id="traps-a" class="traps" onclick="selectList(this);" src="{{ asset('/images/body/08-TrapsLeft.png') }}">
